...
\todo[inline]{add some text about log los -- carrie has tex comments below} 
% $-\ln 0.4
% i think we need the actual log loss equation here, but it wasn't defined explicitly in A3, it's just -\ln (probability value)
% the towards data science has an equation, is this the one we want to use?
