...
\centering
%\caption{Image from Esma Bozkurt}% https://medium.com/analytics-vidhya/introduction-to-machine-learning-regression-5bbf4ed96f40}
\centering
\end{figure}
\begin{center}
...
\end{center}
\todo[inline]{Sam can't figure out how to get the caption to show up below and include a link to the original medium article so faking it, Carrie feel free to fix if it's easy, otherwise this is fine.}
...
\todo[inline]{Confirm that we won't do cross-validation yet, otherwise delete that sentence.}
...
\todo[inline]{If they will also be introduced to pandas, then we can mention that too.}
