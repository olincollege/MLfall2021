...
\todo{will we encourage pairs?- update here.}
...
\todo{can they use libraries or is this from scratch-- update here.}
...
Deliverables
A clean report in notebook format with thoughtful explanations of the considerations for your computer vision application and important highlights of your analysis. This should include in-line code and figures.
This should NOT include every analysis and figure that you generated. Please choose 3 interesting things that you investigated and share your code and figures for these. You can mention other things that you investigated in the text and include the code in your repository. This is about quality, not quantity.
See the project description for information about what you should include (e.g, important considerations for your application, visualizations of data, testing results, etc).
A repository of your other analysis files (you may have multiple notebooks where you experimented with different things). This can be in whatever format works for you (e.g., github, google drive, zip file). We will not assess the polish of these files.
...
Assessment
50\% Constructive engagement (individual): You will self-assess based on our shared rubric and include an explanation of your self-assessment. This aspect of your grade will be largely based on your self-assessment, but we may adjust your constructive engagement based on your explanation and our observations.
50\% Project work and report (team):  We will assess and provide feedback on your final report. This should be in the form of a Jupyter notebook. This notebook should not be an extensive record of all the work you did, rather a polished report that explains the work you did with accompanying code. 
...
\todo{Many links are broken, I've commented them out but we should find them}
...
\section{Appendix D: Rubric for Jupiter Notebook}
...
\todo{self assessment goals-- add in}
